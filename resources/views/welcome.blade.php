        ...
        <div class="container vujade_wrapper">
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <div class="vujade_title"><img src="{{asset('images/vuja.png')}}" style="height: 320px;width:320px;" alt=""></div>
                    {{-- <div class="vujade_subtitle">New Urban City</div> --}}
        ...
        <div id="vujade_service" class="container">
            ...
            <div class="row vujade_ordering">
                ...
                <div class="col-md-6 vujade_service two">
                    <div class="gallery-item">
                        <img src="{{asset('images/fablab.png')}}"  style="width: 500px ; height: 400px" alt="gallery 2">
